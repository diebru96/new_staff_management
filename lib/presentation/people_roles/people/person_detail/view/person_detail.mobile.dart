...
class PersonPageMobile extends StatelessWidget {
  const PersonPageMobile({super.key});
      ...
      child: Column(
        children: [
          ...
          personDetailField("Email", state.person.email ?? "", context,
              fieldMap: 'email'),
          personDetailField("Azienda", state.person.company.toString(), context,
              fieldMap: 'company'),
          personDetailField(
          ...
          personDetailField("Prov", state.person.prov ?? "", context,
              fieldMap: 'prov'),
          personDetailField("ZipCode", state.person.zipcode.toString(), context,
              fieldMap: 'zipcode'),
          personDetailField(
